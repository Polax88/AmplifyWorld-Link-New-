...
/**
 * Curated theme presets. Three free (the free plan's fixed accent-color
 * swatches — on by default for every page), three premium (unlocked by
 * spending $AMPS — see apps/web's `amps.unlockTheme`). Adding a preset is
 * additive: no migration, `Page.theme` just stores its `key`.
 */
export const THEME_PRESETS: ThemePreset[] = [
  ...
  { key: 'coral', displayName: 'Coral', accentColor: '#ff6b6b', isPremium: false, ampsCost: 0 },
